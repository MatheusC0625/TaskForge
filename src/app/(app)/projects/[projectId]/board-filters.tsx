      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-2">
          <input
            ...
            className="w-56 rounded-lg border border-neutral-300 px-3 py-1.5 text-sm outline-none focus:border-neutral-900"
          />
        ...
        <div className="flex rounded-lg border border-neutral-300 p-0.5 text-sm">
          <button
            ...
            className={`rounded-md px-3 py-1 font-medium transition ${
              viewMode === "kanban" ? "bg-neutral-900 text-white" : "text-neutral-600"
            }`}
          >
            Kanban
          </button>
          <button
            ...
            className={`rounded-md px-3 py-1 font-medium transition ${
              viewMode === "lista" ? "bg-neutral-900 text-white" : "text-neutral-600"
            }`}
          >
            Lista
          </button>
