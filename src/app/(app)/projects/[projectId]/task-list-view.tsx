        ...
        return (
          <div key={column.id}>
            <h3 className="mb-2 text-sm font-medium text-neutral-500">
              {column.name} <span className="text-neutral-400">({visibleTasks.length})</span>
            </h3>
              ...
              {visibleTasks.map((task) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center justify-between gap-4 px-4 py-3 text-left transition hover:bg-neutral-50"
                  >
                    ...
                    <div className="flex shrink-0 items-center gap-3 text-xs text-neutral-500">
                      ...
                      {task.dueDate && (
                        <span
                          className={
                            isOverdue(task.dueDate) ? "font-medium text-red-600" : undefined
                          }
                        >
